...
describe("Unit Tests for RegisterStudentUseCase", () => {
  ...
  beforeAll(() => {
    ...
    output = { id: "any-id-test-bora-bill", name: "test of jungle", email: "testofjungle@email.com", registrationNumber: "2024030902", status: "active"};
  ...
  test("should call LoadStudentByRegistrationNumber with provided registration number", async () => {
    ...
    expect(loadStudentByRegistrationNumber.loadByRegistrationNumber).toHaveBeenCalledWith(RegistrationNumber.create("2024030902"));
  });
